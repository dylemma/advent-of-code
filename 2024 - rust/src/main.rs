...
fn main() -> GenResult<()> {
    ...
    match puzzle_num {
        ...
        18 => puzzle18::run(&puzzle_input_path, is_example_input)?,
        19 => puzzle19::run(&puzzle_input_path)?,
        20 => puzzle20::run(&puzzle_input_path, is_example_input)?,
        21 => puzzle21::run(&puzzle_input_path)?,
